    ...
    <div class="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12">
      <div class="w-full max-w-md space-y-8">
        <div class="text-center md:text-left">
          <h2 class="text-3xl font-bold text-gunmetal">Welcome back</h2>
          <p class="text-elephant mt-2">Sign in to access your trading dashboard.</p>
        </div>

        <form @submit.prevent="handleLogin" class="space-y-5 bg-white/60 p-8 rounded-2xl border border-elephant/10 shadow-sm">
          <div>
